<!-- ESTA ES LA VISTA DEL MODULO DE "CONSULTA COMPLETA" EN ESTE MODULO SE MUESTRAN TODOS LOS ACTIVOS FIJOS Y TODAS LAS COLUMNAS DE LA TABLA DE LA BASE DE DATOS. 
     EL CONTENIDO DE LA TABLA DE ESTE MODULO SE GENERA EN UN AJAX QUE ES LLAMADO DESDE UN JAVASCRIPT QUE ESTA EN "vistas/JS/inventario.js"-->

<div class="content-wrapper">

    <section class="content-header">

        <h1>Administrador de Celulares y Teléfonos fijos<small>Panel de control</small></h1>

        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li class="active">Administrador de Celulares y Teléfonos fijos</li>
        </ol>
        ...
        <!-- Aquí van los botones para agregar activos fijos, para exportar el contenido de la tabla a un excel o para exportarlo a un PDF junto con el título  -->
            ...
            <div class="box-header with-border">
                ...
                <!-- Boton para exportar la tabla a un excel -->
                    ...
                    <button class="btn btn-success" style="margin-left: 15px" id="reporteTelefonos">Exportar a excel</button>
                    ...
                    <div class="input-group"> 
                        ...
                        <div class="input-group-btn">
                            <button class="btn btn-danger btnImprimirReporteTel" id="btnImprimirReporteTel" style="width: 120px; margin-left: 15px">Exportar a PDF</button>
                        </div>    
                            <input type="text" class="form-control" id="NombreReporteDeTelefonos" name="NombreReporteDeTelefonos" placeholder="Ingresa el título del reporte" style="width: 400px">
                ...
                <div class="box-body">
                                    ...
                                    <div class="col-lg-12 d-lg-flex">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroSerieTelefono" placeholder="Serie" data-index="0">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroTipoTelefono" placeholder="Tipo" data-index="1">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroMarcaTelefono" placeholder="Marca" data-index="2">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroModeloTelefono" placeholder="Modelo" data-index="3">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroEstadoTelefono" placeholder="Estado" data-index="4">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroAsignadoTelefono" placeholder="Asignado" data-index="5">
                                    ...
                                    <div class="col-lg-12 d-lg-flex" style="margin-top: 15px;">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroDepartamentoTelefono" placeholder="Departamento" data-index="6">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroUbicacionTelefono" placeholder="Ubicación" data-index="7">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroEmpleadoTelefono" placeholder="Empleado asignado" data-index="8">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroTelefonoTelefono" placeholder="Número de Tel." data-index="9">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroImeiTelefono" placeholder="IMEI" data-index="10">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroEmailTelefono" placeholder="Email" data-index="11">
                                    ...
                                    <div class="col-lg-12 d-lg-flex" style="margin-top: 15px;">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroContratoTelefono" placeholder="Contrato" data-index="12">
                                        ...
                                        <div class="col-sm-1" style="width: 16.6%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input" id="filtroMacTelefono" placeholder="MAC" data-index="13">
                    ...
                    <table class="table table-bordered table-striped dt-responsive tablaInventarioTelefonos" id="tablaInventarioTelefonos" style="width:100%">
...
<div id="modalAgregarAF" class="modal fade" role="dialog">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <div class="modal-content">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control input-lg" name="nuevoTipo" required>
                                        ...
                                        <option value="">Seleccionar tipo de teléfono</option>
            ...
            $registrarTelefono = new ControladorInventarioTelefonos();
            $registrarTelefono->ctrRegistrarTelefonos();
...
<div id="modalEditarAF" class="modal fade" role="dialog">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            $editarTelefonos = new ControladorInventarioTelefonos();
            $editarTelefonos->ctrEditarTelefonos();
...
$eliminarTelefonos = new ControladorInventarioTelefonos();
$eliminarTelefonos->ctrEliminarTelefonos();
?>