...
class tablaInventarioPC
{
    ...
    public function mostrarTablaInventarioPC()
    {
        $item = null;
        $valor = null;
        $itemTipo = "id_tipo";
        ...
        $AFs = ControladorInventarioPC::ctrMostrarPC($item, $valor);
...
$activarInventarioPC = new tablaInventarioPC();
$activarInventarioPC->mostrarTablaInventarioPC();
