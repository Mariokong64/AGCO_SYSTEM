...
class tablaInventarioTelefonos
{
    ...
    public function mostrarTablaInventarioTelefonos()
    {
        $item = null;
        $valor = null;
        $itemTipo = "id_tipo";
        ...
        $AFs = ControladorInventarioTelefonos::ctrMostrarTelefonos($item, $valor);
        ...
        for ($i = 0; $i < count($AFs); $i++) {
            ...
            $botones = "<div class='btn-group'><button class='btn btn-warning btnEditarAF' idInventario='" . $AFs[$i]["id_inventario"] . "' data-toggle='modal' data-target='#modalEditarAF' style='margin-left: 3px;'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarAF' idInventario='" . $AFs[$i]["id_inventario"] . "' style='margin-left: 3px;'><i class='fa  fa-trash-o'></i></button></div>";
            ...
            switch ($AFs[$i]["id_estado"]) {
                ...
                case 5:
                    ...
                    $botones = "<div class='btn-group'><button class='btn btn-github btnEditarAF' idInventario='" . $AFs[$i]["id_inventario"] . "' data-toggle='modal' data-target='#modalEditarAF' style='margin-left: 3px;'><i class='fa fa-pencil'></i></button><button class='btn btn-github btnEliminarAF' idInventario='" . $AFs[$i]["id_inventario"] . "' style='margin-left: 3px;'><i class='fa  fa-trash-o'></i></button></div>";
                    break;
                default:
                    $AFestado = 'NA';
                    break;
...
$activarInventarioTelefonos = new tablaInventarioTelefonos();
$activarInventarioTelefonos->mostrarTablaInventarioTelefonos();
